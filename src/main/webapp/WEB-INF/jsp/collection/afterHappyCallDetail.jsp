        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200" id="scoreTable">
                ...
                <tr>
                    ...
                    <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">스크립트 준수</th>
                    <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">종료인사</th>
                </tr>
                </thead>
                <tbody id="scriptScoreBody" class="bg-white divide-y divide-gray-200">
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-900">5</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-900">35</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-900">5</td>
                    </tr>

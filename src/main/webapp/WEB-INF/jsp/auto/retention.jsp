        ...
        <div class="grid grid-cols-3 gap-4">
          ...
          <div class="flex items-center">
            ...
            <div class="flex space-x-2">
              <label class="inline-flex items-center">
                <input type="checkbox" name="intention" value="" checked class="mr-1">
                <span>전체</span>
              </label>
              <label class="inline-flex items-center">
          ...
          <div class="flex items-center">
            ...
            <div class="flex space-x-4">
              <label class="inline-flex items-center">
                <input type="radio" name="decision" value="" checked class="mr-1">
                <span>전체</span>
              </label>
              <label class="inline-flex items-center">
                <input type="radio" name="decision" value="C0049" class="mr-1">
                <span>연장</span>
              </label>
              <label class="inline-flex items-center">
                <input type="radio" name="decision" value="C0050" class="mr-1">
                <span>연장 이외</span>
              </label>
              <label class="inline-flex items-center">
                <input type="radio" name="decision" value="C0051" class="mr-1">
                <span>미결정</span>
              </label>
            </div>
          </div>
          ...
          <div class="flex items-center">
            ...
            <div class="flex space-x-4">
              <label class="inline-flex items-center">
                <input type="radio" name="recallprom" value="" checked class="mr-1">
                <span>전체</span>
              </label>
              <label class="inline-flex items-center">
                <input type="radio" name="recallprom" value="Y" class="mr-1">
                <span>Y</span>
              </label>
              <label class="inline-flex items-center">
                <input type="radio" name="recallprom" value="N" class="mr-1">
                <span>N</span>
              </label>
            </div>
          </div>
        ...
        <div class="flex justify-between items-center">
          <div class="flex items-center space-x-4">
            ...
            <span class="totalCount text-sm text-blue-600 bg-blue-50 px-2 py-1 rounded-full">
                총 <span class="font-bold"></span>건
            </span>
              <span class="customerCount text-sm text-emerald-700 bg-emerald-50 px-2 py-1 rounded-full">
                상담 고객 <span class="font-bold count">0</span>명
              </span>
              <span class="extCustomerCount text-sm text-purple-700 bg-purple-50 px-2 py-1 rounded-full">
                만기 고객 <span class="font-bold count">0</span>명
              </span>
          </div>
      ...
      <div class="overflow-x-auto">
        <table id="mstrListTable" class="sortable min-w-full divide-y divide-gray-200">
          ...
          <tr>
            ...
            <th scope="col" class="px-4 py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider" data-sort="item01">만기일자</th>
            ...
            <th scope="col" class="px-4 py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider" data-sort="item02">결정구분</th>
            <th scope="col" class="px-4 py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider" data-sort="item03">고객의향</th>
            <th scope="col" class="px-4 py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider" data-sort="item04">리콜약속</th>
            <th scope="col" class="px-4 py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider" data-sort="item05">약속일시</th>
      ...
      <div class="overflow-x-auto">
        <table id="mstrStatsTable" class="min-w-full divide-y divide-gray-200">
          ...
          <tr class="bg-gray-50">
            ...
            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" data-header="custCnt">상담 고객 수</th>
            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" data-header="custRto">비중(%)</th>
            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" data-header="expCustCnt">만기 고객 수</th>
            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" data-header="expCustRto">비중(%)</th>
          </tr>
          </thead>

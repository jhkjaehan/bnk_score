                ...
                <nav class="hidden md:flex space-x-6">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute left-0 w-48 bg-white border rounded shadow-lg hidden group-hover:block z-50">
                            ...
                            <a href="${pageContext.request.contextPath}/#" class="block px-4 py-2 text-sm hover:bg-gray-100">채권추심</a>
                        </div>
                    </div>
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute left-0 w-56 bg-white border rounded shadow-lg opacity-0 group-hover:opacity-100 transition duration-200 invisible group-hover:visible">
                            <a href="${pageContext.request.contextPath}/retail/excellentLoanPage.do" class="block px-4 py-2 text-sm hover:bg-gray-100">우수추가대출</a>
                            <a href="${pageContext.request.contextPath}/retail/loanAgreementPage.do" class="block px-4 py-2 text-sm hover:bg-gray-100">대출취급약정안내</a>
                        </div>
                    </div>
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute left-0 w-48 bg-white border rounded shadow-lg opacity-0 group-hover:opacity-100 transition duration-200 invisible group-hover:visible">
                            ...
                            <a href="${pageContext.request.contextPath}/#" class="block px-4 py-2 text-sm hover:bg-gray-100">사전해피콜</a>
                        </div>
                    </div>

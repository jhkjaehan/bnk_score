    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="overflow-x-auto">
            <table id="mstrListTable" class="min-w-full divide-y divide-gray-200">
                ...
                <!-- 평가내용 행들 -->
                <tr>
                    <td rowspan="8" class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">상담수행</td>
                    <td rowspan="5" class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">단계진행</td>
                    <td class="px-6 py-4 text-sm text-gray-900">용건안내</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-green-600">Y/N</td>
                </tr>
                <tr>
                    <td class="px-6 py-4 text-sm text-gray-900">링크발송</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-green-600">Y/N</td>
                </tr>
                <tr>
                    <td class="px-6 py-4 text-sm text-gray-900">신용조회동의및적합성조사</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-green-600">Y/N</td>
                </tr>
                <tr>
                    <td class="px-6 py-4 text-sm text-gray-900">대출조건안내</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-green-600">Y/N</td>
                </tr>
                <tr>
                    <td class="px-6 py-4 text-sm text-gray-900">신청정보확인및설명의무</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-green-600">Y/N</td>
                </tr>
                <tr>
                    <td rowspan="3" class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">단계진행</td>
                    <td class="px-6 py-4 text-sm text-gray-900">성사</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-green-600">Y/N</td>
                </tr>
                <tr>
                    <td class="px-6 py-4 text-sm text-gray-900">거절</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-green-600">Y/N</td>
                </tr>
                <tr>
                    <td class="px-6 py-4 text-sm text-gray-900">보류</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-green-600">Y/N</td>
                </tr>
                </tbody>
            </table>
